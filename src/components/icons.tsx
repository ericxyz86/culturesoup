export function FireIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
      <path d="M12 23c-3.866 0-7-3.134-7-7 0-2.692 1.36-4.842 2.573-6.226A15.8 15.8 0 0 1 9.6 7.8c.176-.153.366-.347.521-.525a.5.5 0 0 1 .828.098c.247.472.46 1.093.602 1.762.318-1.08.86-2.375 1.764-3.412C14.628 4.243 16.5 3 19 3a.5.5 0 0 1 .425.765C18.6 5.14 18 6.866 18 8.5c0 .952.283 1.8.632 2.517.357.735.792 1.357 1.13 1.783l.083.104a.5.5 0 0 1 .09.3C19.934 19.866 16.866 23 13 23h-1Z" />
    </svg>
  );
}
